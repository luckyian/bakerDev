        ...
        <Navbar expand="md" className="navibar text" variant="dark" sticky="top">
            ...
            <div className="col-md-3">
                <Navbar.Collapse id="navbarNavAltMarkup">
                    <Nav>
                        <Nav.Link className="text" href="bakerDev/#/index" >Home</Nav.Link>
                        <Nav.Link className="text" href="bakerDev/#/cakes" >Goods</Nav.Link>
                        {/* <Nav.Link href="/fortressofthebear/#/store" >Store</Nav.Link> */}
                        <Nav.Link className="text" href="bakerDev/#/contact" >Order</Nav.Link>
